...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_experimentKey": "OPT-54C5LBG_OPT-M2DH3",
                "function": "__c",
                "vtp_value": true
            }, {
                "function": "__u",
                ...
                "function": "__exs",
                "vtp_measurementId": "bJFmv3EITOWBRSOU0fWwDw",
                "vtp_sections": ["list", 2]
            }, {
                "vtp_experimentKey": "OPT-54C5LBG_OPT-M2DH3",
                "function": "__c",
                ...
                "function": "__c",
                "vtp_value": ["map", "", 19414, "WlEvp1u4SVe_EjglsvIyGQ", 0, "bCvIYWQhR4SHJjK_rJJckw", 19504, "zPxKEsYwRNmaonI09dxghw", 0, "bJFmv3EITOWBRSOU0fWwDw", 19505, "DadmcPyBQB6FtJ2l1z2Jag", 0, "Ekqvdiu_RYSe8exhq_zeAA", 0, "kujEMQE9RW6v2Okp6TRsPQ", 0, "KIvcXOcuQ2Kf6bVWxvIM5g", 0, "YDQuXxK3QfG5BUa4Ct4Geg", 0, "8n_p_gJfSGuXcU08wm5wMA", 0, "YU_8jOlRQFWMHgX-AEdtPg", 19504]
            }, {
                "vtp_experimentKey": "OPT-54C5LBG_OPT-WSR2S",
                "function": "__c",
                "vtp_value": true
            }, {
                "function": "__exs",
                "vtp_measurementId": "YU_8jOlRQFWMHgX-AEdtPg",
                "vtp_sections": ["list", 2]
            }, {
                "vtp_experimentKey": "OPT-54C5LBG_OPT-WSR2S",
                "function": "__c",
                ...
                "vtp_experimentKey": "OPT-54C5LBG_OPT-KKVML",
                "function": "__c",
                "vtp_value": true
            }, {
                "function": "__exs",
                "vtp_measurementId": "bCvIYWQhR4SHJjK_rJJckw",
                "vtp_sections": ["list", 2]
            }, {
                "vtp_experimentKey": "OPT-54C5LBG_OPT-KKVML",
                "function": "__c",
            ...
            "tags": [{
                ...
                "vtp_activate": true,
                "vtp_isEmpty": false,
                "vtp_treatmentId": "Experiment_OPT-54C5LBG_OPT-WSR2S:0",
                "vtp_contextIndex": 0,
                ...
                "vtp_activate": true,
                "vtp_isEmpty": false,
                "vtp_treatmentId": "Experiment_OPT-54C5LBG_OPT-M2DH3:0",
                "vtp_contextIndex": 0,
                "vtp_useMutationObserver": true,
                "vtp_waitForElements": true,
                "tag_id": 27
                ...
                "vtp_selector": "",
                "vtp_identifier": "",
                "vtp_script": "  var aimtellCustomAttributes = null;\n  var _getCookieValue = function (name) {\n    var cookieName = encodeURIComponent(name) + \"=\";\n    var cookieArray = document.cookie.split(';');\n    for (var i = 0; i \u003C cookieArray.length; i++) {\n      var cookieItem = cookieArray[i].trim();\n      if (cookieItem.indexOf(cookieName) === 0) {\n        return decodeURIComponent(cookieItem.substring(cookieName.length, cookieItem.length));\n      }\n    }\n    return '';\n  };\n  try {\n    var _officialRegion = _getCookieValue('region');\n    var _officialLang = _getCookieValue('lang');\n    if (_officialRegion) {\n      aimtellCustomAttributes = aimtellCustomAttributes || {};\n      aimtellCustomAttributes['official_region'] = _officialRegion.toUpperCase();\n    }\n    if (_officialLang) {\n      aimtellCustomAttributes = aimtellCustomAttributes || {};\n      aimtellCustomAttributes['official_lang'] = _officialLang;\n    }\n  } catch (e) {\n    console.error(e);\n  }\n\n  try {\n    window._aimtellReady = window._aimtellReady || function () {\n      window.ga \u0026\u0026 ga('send', 'event', 'webpush', 'load', 'push');\n      if (typeof _aimtellSupportsPush === 'function') {\n        var isBrowserSupported = _aimtellSupportsPush();\n        window.ga \u0026\u0026 ga('send', 'event', 'webpush', 'support', isBrowserSupported + '');\n      }\n    }\n    window._aimtellPermissionGranted = window._aimtellPermissionGranted || function () {\n      window.ga \u0026\u0026 ga('send', 'event', 'webpush', 'click', 'push_subscribe');\n    }\n    window._aimtellPermissionIgnored = window._aimtellPermissionIgnored || function () {\n      window.ga \u0026\u0026 ga('send', 'event', 'webpush', 'ignore', 'push');\n    };\n    window._aimtellPermissionDenied = window._aimtellPermissionDenied || function () {\n      window.ga \u0026\u0026 ga('send', 'event', 'webpush', 'denied', 'push');\n    }\n    \/\/ aimtell\n    window._at = {};\n    window._at.track = window._at.track || function () {\n      (window._at.track.q = window._at.track.q || []).push(arguments);\n    };\n    _at.domain = 'www.dji.com';\n    _at.owner = 'ab1d02e46dbb';\n    _at.idSite = '26937';\n    _at.attributes = {};\n    _at.webpushid = 'web.2.aimtell.com';\n    _at.showCredit = false;\n    if (aimtellCustomAttributes) {\n      _at.track(\"attribute\", aimtellCustomAttributes);\n    }\n    (function () {\n      var u = '\/\/cdn.aimtell.com\/trackpush\/';\n      var d = document,\n        g = d.createElement('script'),\n        s = d.getElementsByTagName('script')[0];\n      g.type = 'text\/javascript';\n      g.async = true;\n      g.defer = true;\n      g.src = u + 'trackpush.min.js';\n      s.parentNode.insertBefore(g, s);\n    })();\n  } catch (e) {\n    console.error(e);\n  }",
                ...
                "vtp_activate": true,
                "vtp_isEmpty": false,
                "vtp_treatmentId": "Experiment_OPT-54C5LBG_OPT-KKVML:0",
                "vtp_contextIndex": 0,
                "vtp_useMutationObserver": true,
                "vtp_waitForElements": true,
                "tag_id": 58
                ...
                "vtp_selector": "head",
                "vtp_identifier": "head",
                "vtp_html": "\u003Cstyle\u003E\npushboxcontainer pushbox {\n  font-family : \"Open Sans\", \"PingFang SC\", \"Microsoft YaHei\", \"Helvetica Neue\", \"Hiragino Sans GB\", \"WenQuanYi Micro Hei\", Arial, sans-serif !important;\n  padding : 16px 24px 16px 8px !important;\n  border: none !important;\n  box-shadow: 0 8px 16px rgb(0 0 0 \/ 10%) !important;\n  letter-spacing: -0.02em !important;\n}\npushboxcontainer pushbox pushbox-cta {\n  padding-top: 0 !important;\n}\npushboxcontainer pushbox notibody {\n  padding-left: 0 !important;\n}\npushboxcontainer pushbox noticon {\n  pointer-events: none !important;\n  margin-top: 0 !important;\n}\npushboxcontainer pushbox a {\n  pointer-events: none !important;\n}\npushboxcontainer pushbox noticon path {\n  fill: rgba(0,0,0,0.85) !important;\n}\npushboxcontainer pushbox notibody teaser {\n  font-weight : 600 !important;\n  font-size : 16px !important;\n  letter-spacing: -0.02em !important;\n  margin-bottom : 4px !important;\n  color: rgba(0,0,0,0.85) !important;\n}\npushboxcontainer pushbox notibody teaser-byline {\n  font-size : 14px !important;\n  letter-spacing: -0.02em !important;\n  line-height: 20px !important;\n  color: rgba(0,0,0,0.65) !important;\n}\npushboxcontainer pushbox pushbox-cta buttons button-approve, pushbox pushbox-cta buttons button-deny {\n  font-size : 14px !important;\n  letter-spacing: -0.02em !important;\n  padding: 6px 16px !important;\n  margin-top: 16px !important;\n}\npushboxcontainer pushbox pushbox-cta buttons button-approve {\n  color: #fff !important;\n  background-color: #0070D5 !important;\n  margin-right: 0 !important;\n  border-radius: 88rem;\n  transition: background-color 0.3s ease;\n}\npushboxcontainer pushbox pushbox-cta buttons button-approve:hover {\n  background-color: #2490e3 !important;\n}\npushboxcontainer pushbox pushbox-cta buttons button-approve:active {\n  background-color: #0058b0 !important;\n}\npushboxcontainer pushbox pushbox-cta buttons button-deny {\n  color: rgba(0,0,0,0.65) !important;\n  margin-right: 8px !important;\n}\n\u003C\/style\u003E",
                "vtp_mode": "APPEND",
                "tag_id": 45
            }, {
                "function": "__exsu",
                ...
                "vtp_selector": "",
                "vtp_identifier": "",
                "vtp_script": "try {\n  var winUserAgent = window.navigator.userAgent;\n  var isWeixinUA = \/MicroMessenger\/ig.test(winUserAgent);\n  var isIosUA = \/iphone|ipad\/ig.test(winUserAgent);\n  var isAndroidUA = \/android\/ig.test(winUserAgent);\n  \n  var appDownloadLink = 'https:\/\/plus.dji.com\/apps\/download?utm_source=OfficialSite\u0026utm_medium=ceiling\u0026utm_campaign=app_download';\n  if (isIosUA) {\n    appDownloadLink = 'https:\/\/apps.apple.com\/app\/apple-store\/id899147555?pt=1984541\u0026ct=OfficialSite\u0026mt=8';\n  } else if (isAndroidUA) {\n    appDownloadLink = 'https:\/\/play.google.com\/store\/apps\/details?id=com.dji.overSeaStore\u0026utm_source=OfficialSite\u0026utm_medium=ceiling\u0026utm_campaign=app_download';\n  }\n      \n  if (isWeixinUA \u0026\u0026 !isAndroidUA) return;\n  \n  var uptScript = document.createElement('script');\n  uptScript.defer = 'defer';\n  uptScript.src = 'https:\/\/dji-official-fe.djicdn.com\/assets\/uploads\/p\/b6c9a2ce-dee1-4bd3-9298-10b672528021\/universal-product-tip-uglify.js';\n  uptScript.onload = function () {\n    if (typeof ga === 'function') {\n      ga('set', 'transport', 'beacon');\n    }\n    var initUPT = function () {\n      var _initUPT = function () {\n        var upt = new UniversalProductTip({\n          product_slug: 'app_downloads_2',\n          available_regions:['MO','MC','DE','LU','LI','BE','GB','IT','AT','US','FR','ES','SG','NL','SI','GR','PL','PT','LV','EE','SK','HU','DK','MT','FI','HR','CZ','JP','SE','CH','CA','IE','LT','BG','NO','HK','AU','NZ','PR','TW','KR'],\n          translation: {\n            title: {\n              'zh-CN': '',\n              en: \"DJI's official shopping platform, providing a one-stop shop for DJI products, services, and more.\",\n              'zh-TW': '大疆產品首選購物平台，為用戶提供一站式服務。',\n              ja: 'DJIの新製品をいち早くお届けできるプラットフォーム',\n              ko: 'DJI 공식 쇼핑 플랫폼으로 DJI 제품, 서비스를 한 곳에서 구매할 수 있습니다.',\n              de: 'Hier bekommst du neue DJI-Produkte als Erstes',\n              ru: '',\n              fr: 'La première plateforme à expédier les nouveaux produits DJI',\n              it: 'La prima piattaforma per la spedizione di nuovi prodotti DJI',\n              es: 'La primera plataforma en enviar nuevos productos de DJI',\n              'pt-BR': '',\n            },\n            'learn-more': {\n              'zh-CN': '',\n              en: 'Download the App',\n              'zh-TW': '下載應用程式',\n              ja: 'アプリをダウンロード',\n              ko: '앱 다운로드',\n              de: 'App herunterladen',\n              ru: '',\n              fr: 'Télécharger l’appli',\n              it: \"Scarica l'app\",\n              es: 'Descargar la aplicación',\n              'pt-BR': '',\n            },\n            'learn-more-link': {\n              'zh-CN': '',\n              en: appDownloadLink,\n              'zh-TW': appDownloadLink,\n              ja: appDownloadLink,\n              ko: appDownloadLink,\n              de: appDownloadLink,\n              ru: '',\n              fr: appDownloadLink,\n              it: appDownloadLink,\n              es: appDownloadLink,\n              'pt-BR': '',\n            },\n          },\n        });\n      };\n\n      if (document.readyState === 'complete') {\n        setTimeout(_initUPT, 200);\n      } else {\n        document.onreadystatechange = function () {\n          if (document.readyState === \"complete\") {\n            setTimeout(_initUPT, 200);\n          }\n        }\n      }\n    };\n    if (\/complete|interactive|loaded\/.test(document.readyState)) {\n      initUPT();\n    } else {\n      document.addEventListener('DOMContentLoaded', function () {\n        initUPT();\n      }, {passive: true});\n    }\n  };\n  document.body.appendChild(uptScript);\n} catch(e){console.error(e);}\n",
                "vtp_requiresContent": false,
                "tag_id": 29
            }],
            "predicates": [{
                ...
                "function": "_cn",
                "arg0": ["macro", 3],
                "arg1": ["list", "\/teaser", "\/trailer", "\/flysafe\/geo-map", "flysafe"],
                "any_of": true
            }, {
                "function": "_cn",
                "arg0": ["macro", 3],
                ...
                "function": "_re",
                "arg0": ["macro", 3],
                "arg1": "(\/(ca-fr|cn|hk-en|hk|mo|tw|id|jp|sg|kr|nz|at|ru|be|bg|hr|cz|dk|ee|fi|fr|de|gr|hu|ie|it|lv|li|lt|lu|mt|mc|nl|no|pl|pt|sk|si|es|se|ch|ae|mx|pr|br))((\/.*)|$|(\\?.*))"
            }, {
                "function": "_eq",
                "arg0": ["macro", 18],
                "arg1": true
    ...
    */
    ...
    var Wb = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/,
        ...
        G = function(a, b) {
            ...
            for (d in a)
                if (Yb(a, d)) {
                    var e = a[d];
                    "array" == Xb(e) ? ("array" != Xb(c[d]) && (c[d] = []), c[d] = G(e, c[d])) : Zb(e) ? (Zb(c[d]) || (c[d] = {}), c[d] = G(e, c[d])) : c[d] = e
                }
            return c
        };
    var ac = function(a) {
    ...
    var Qc = {
        kj: function(a, b) {
            b[bc.Sf] && "string" === typeof a && (a = 1 == b[bc.Sf] ? a.toLowerCase() : a.toUpperCase());
    ...
    var gd = /:[0-9]+$/,
        ...
        od = function(a, b, c, d, e) {
            ...
            if ("protocol" === b || "port" === b) a.protocol = md(a.protocol) || md(z.location.protocol);
            "port" === b ? a.port = String(Number(a.hostname ? a.port : z.location.port) || ("http" === a.protocol ? 80 : "https" ===
                a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || z.location.hostname).replace(gd, "").toLowerCase());
            return nd(a, b, c, d, e)
        },
    ...
    var N = {
        ...
        ie = {},
        je = Object.freeze((ie[N.g.X] = 1, ie[N.g.nd] = 1, ie[N.g.vb] = 1, ie[N.g.ba] = 1, ie[N.g.hb] = 1, ie[N.g.Ja] = 1, ie[N.g.ib] = 1, ie[N.g.wc] = 1, ie[N.g.Ae] = 1, ie[N.g.Ta] = 1, ie[N.g.Nb] =
            1, ie[N.g.yc] = 1, ie[N.g.Z] = 1, ie[N.g.Be] = 1, ie[N.g.Ob] = 1, ie[N.g.Ed] = 1, ie[N.g.Fd] = 1, ie[N.g.Gd] = 1, ie[N.g.Ge] = 1, ie[N.g.Va] = 1, ie[N.g.Jd] = 1, ie[N.g.Kd] = 1, ie[N.g.Ie] = 1, ie[N.g.Md] = 1, ie[N.g.qa] = 1, ie[N.g.Ke] = 1, ie[N.g.Nd] = 1, ie[N.g.zb] = 1, ie[N.g.Fa] = 1, ie[N.g.Bb] = 1, ie[N.g.Ec] = 1, ie[N.g.Le] = 1, ie[N.g.Fc] = 1, ie[N.g.ma] = 1, ie[N.g.Gc] = 1, ie[N.g.Ve] = 1, ie[N.g.Ga] = 1, ie[N.g.Mc] = 1, ie));
    Object.freeze([N.g.Ea, N.g.La, N.g.Tb, N.g.Ka, N.g.Cg, N.g.ra, N.g.Fe, N.g.ni]);
    var ke = {},
        le = Object.freeze((ke[N.g.ci] = 1, ke[N.g.di] = 1, ke[N.g.ei] = 1, ke[N.g.fi] = 1, ke[N.g.gi] = 1, ke[N.g.hi] = 1, ke[N.g.ii] = 1, ke[N.g.ji] = 1, ke[N.g.ki] = 1, ke[N.g.xe] = 1, ke)),
        me = {},
        ne = Object.freeze((me[N.g.Xf] = 1, me[N.g.Yf] = 1, me[N.g.kc] = 1, me[N.g.mc] = 1, me[N.g.Zf] = 1, me[N.g.Kb] = 1, me[N.g.nc] = 1, me[N.g.tb] = 1, me[N.g.Lb] = 1, me[N.g.ub] = 1, me[N.g.Aa] = 1, me[N.g.oc] = 1, me[N.g.Ba] = 1, me[N.g.ag] = 1, me)),
        ...
        ue = {},
        ve = Object.freeze((ue[N.g.X] = 1, ue[N.g.nd] = 1, ue[N.g.ya] = 1, ue[N.g.wb] = 1, ue[N.g.ze] = 1, ue[N.g.pd] = 1, ue[N.g.qd] = 1, ue[N.g.rd] = 1, ue[N.g.ba] = 1, ue[N.g.sd] = 1, ue[N.g.Da] = 1, ue[N.g.oa] = 1, ue[N.g.hb] = 1, ue[N.g.Ja] = 1, ue[N.g.ib] = 1, ue[N.g.Ta] = 1, ue[N.g.la] = 1, ue[N.g.Ad] = 1, ue[N.g.Z] = 1, ue[N.g.si] = 1, ue[N.g.Ac] = 1, ue[N.g.Dd] = 1, ue[N.g.Fe] = 1, ue[N.g.Gd] = 1, ue[N.g.Md] = 1, ue[N.g.Ka] = 1, ue[N.g.Bc] = 1, ue[N.g.Ea] = 1, ue[N.g.La] = 1, ue[N.g.xg] = 1, ue[N.g.yg] = 1, ue[N.g.zg] =
            1, ue[N.g.Ag] = 1, ue[N.g.zb] = 1, ue[N.g.Fa] = 1, ue[N.g.Bb] = 1, ue[N.g.Fc] = 1, ue[N.g.Ma] = 1, ue[N.g.ma] = 1, ue[N.g.Gc] = 1, ue[N.g.lb] = 1, ue[N.g.na] = 1, ue[N.g.ra] = 1, ue[N.g.ja] = 1, ue));
    Object.freeze(N.g);
    var we = {},
    ...
    var Te = new ua,
        ...
        cf = function(a, b) {
            var c, d = 1 !== (void 0 === b ? 2 : b) ? af(a) : Te.get(a);
        ...
        if (void 0 != b) {
            ...
            if ("" === d || p === e || (p === d ? n !== e : !p && !n)) {
                ...
                q && z.setTimeout(function() {
                    k[a] === u && u.quiet && (u.quiet = !1, of (a), nf(), Ya("TAGGING",
                        2))
                }, f)
            }
        }
    ...
    function kg(a, b) {
        var c = [Bb.userAgent, (new Date).getTimezoneOffset(), Bb.userLanguage || Bb.language, Math.floor(Fa() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*"),
            d;
        if (!(d = Zf)) {
        ...
        Zf = d;
        for (var m = 4294967295, n = 0; n < c.length; n++) m = m >>> 8 ^ Zf[(m ^ c.charCodeAt(n)) & 255];
    ...
    function Rg(a, b) {
        var c = b.split(".");
        5 === c.length ? (Dg[a] = c.slice(0, 2).join("."), Eg[a] = {
            id: c.slice(2, 4).join("."),
            wf: Number(c[4]) || 0
        }) : 3 === c.length ? Eg[a] = {
            id: c.slice(0, 2).join("."),
    ...
    var ei = {
        ...
        gi = function(a) {
            ...
            if (Q(45)) {
                ...
                var f = d.me,
                    g = d.yf;
                void 0 === f ? e = "" : (g || (g = 0), e = "" + Fd(1, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_" [f << 2 | g]);
                var k = d.Rk,
                    m = 4 + e + (k ? "" + Fd(2,
                ...
                var q, u = d.sk;
                q = u ? "" + Fd(4, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_" [u] : "";
                var t;
                var r = d.oj;
                if (r && a) {
                    var v = r.split("-"),
                    ...
                    if ("GTM" !== w && "OPT" !== w) t = "";
                        ...
                        var y = v[1];
                        t = "" + Fd(5, 3) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_" [1 + y.length] + (d.Xj || 0) + y
                    }
                } else t = "";
                return m + n + q + t
            }
            var x = ei[c] || "i",
                ...
                A = "w";
            De && (A = Vh() ? "s" : "o");
            Fe ? ("w" === A && (A = "x"), "o" === A && (A = "q")) : He ? ("w" === A && (A = "y"), "o" === A && (A = "r")) : Je && (A = "z");
    ...
    var ni = function(a, b, c, d) {
        ...
        qi = /[?&]($|#)/,
        ri = function(a, b, c) {
            for (var d, e = a.search(oi), f = 0, g, k = []; 0 <= (g = ni(a, f, b, e));) k.push(a.substring(f,
    ...
    var wi = function() {
            ...
            return a ? a[a.length - 1] == z.location.origin ? 1 : 2 : si(z.top) ? 1 : 2
        },
        vi = function(a, b) {
    ...
    Ci.prototype.addEventListener = function(a) {
        ...
        var f = function(g, k) {
            clearTimeout(e);
            g ? (c = g, c.internalErrorState = Bi(c), c.internalBlockOnErrors = b.I, k && 0 === c.internalErrorState || (c.tcString = "tcunavailable", k || (c.internalErrorState = 3))) : (c.tcString = "tcunavailable", c.internalErrorState = 3);
            a(c)
        };
        try {
    ...
    var Fi = function(a, b, c) {
            ...
            if (0 === k)
                if (a.purpose && a.vendor) {
                    ...
                    m = n && "1" === b && a.purposeOneTreatment && "CH" === a.publisherCC ? !0 : n && Ei(a.purpose.consents, b)
                } else m = !0;
            else m = 1 === k ? a.purpose && a.vendor ? Ei(a.purpose.legitimateInterests,
                b) && Ei(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
            return m
        },
        Ei = function(a, b) {
            return !(!a || !a[b])
    ...
    var Pi = function() {
        ...
        if (!0 === z.gtag_enable_tcf_support && !a.active && ("function" === typeof z.__tcfapi || "function" === typeof b.m.__tcfapi || null != Gi(b))) {
            a.active = !0;
            a.he = {};
            Mi();
                                ...
                                if (Ji.hasOwnProperty(k))
                                    if ("1" === k) {
                                        var m, n = c,
                                            p = !0;
                                        p = void 0 === p ? !1 : p;
                                        m = Ii(n) ? !1 === n.gdprApplies || "tcunavailable" === n.tcString || void 0 === n.gdprApplies && !p || "string" !== typeof n.tcString || !n.tcString.length ? !0 : Fi(n, "1", 0) : !1;
                                        g["1"] = m
    ...
    var Ti = function(a) {
        ...
        Ui = 0 <= z.location.search.indexOf("?gtm_latency=") || 0 <= z.location.search.indexOf("&gtm_latency=");
    var Vi = ["L", "S", "Y"],
        Wi = ["S", "E"],
        Xi = {
            sampleRate: "0.005000",
    ...
    var aj = Yi,
        bj = "https://www.googletagmanager.com/a?id=" + S.C + "&cv=58",
        cj = {
            label: S.C + " Container",
            children: [{
    ...
    function Sj(a) {
        ...
        var c = $a("GTM"),
            ...
            v = kj,
            w;
        return [f, g, k, m, c ? "&u=" + c : "", d ? "&ut=" + d : "", e ? "&h=" + e : "", n, p, q, u, t, r, v, w, mj ? "&dl=" + encodeURIComponent(mj) : "", 0 < lj.length ? "&tdp=" + lj.join(".") : "", we.Lc ?
            "&x=" + we.Lc : "", "&z=0"
        ].join("")
    }
    ...
    ub();
    !qb("Safari") || ub() || (rb() ? 0 : qb("Coast")) || sb() || (rb() ? 0 : qb("Edge")) || (rb() ? pb("Microsoft Edge") : qb("Edg/")) || (rb() ? pb("Opera") : qb("OPR")) || tb() || qb("Silk") || qb("Android") || li();
    var nk = {},
        ok = null,
        pk = function(a) {
            ...
            for (var u = nk[f], t = Array(Math.floor(b.length / 3)), r = u[64] || "", v = 0, w = 0; v < b.length - 2; v += 3) {
                var y = b[v],
                    x = b[v + 1],
                    B = b[v + 2],
                    A = u[y >> 2],
    ...
    function vk() {
        ...
        var b = z.navigator.userAgentData.getHighEntropyValues(qk).then(function(c) {
    ...
    var Dk = /^\w+$/,
        ...
        Hk = function(a, b) {
            sf("ad_storage") ? Gk() ? a() : yf(a, "ad_storage") : b ? Ya("TAGGING", 3) : xf(function() {
                Hk(a, !0)
            }, ["ad_storage"])
        },
        Jk = function(a) {
    ...
    function Qk(a, b, c, d, e) {
        ...
        if (!m && a.gb) {
            var q = a.gb[0],
                ...
                t = !1;
            if (!b)
                for (var r = Ik(u), v = 0; v < r.length; v++) r[v].aa === q && r[v].labels &&
                    ...
                    if (void 0 !== Fk[f]) {
                        ...
                        if (k) {
                            ...
                            b: {
                                var p = m;
                                if (Df(z))
                                    for (var q = Gf(g, D.cookie, void 0, "ad_storage"), u = 0; u < q.length; ++u)
                                        if (Tk(q[u]) > p) {
                                            n = !0;
                                            break b
                                        }
    ...
    var Sl = function(a, b, c, d, e, f, g, k, m, n, p, q) {
        ...
        hm = function(a) {
            return new Sl(a.Ki, a.Li, a.I, a.Sg, a.h, a.M, a.m, a.Ic, a.B, a.jc, a.sb, a.V)
        };
    ...
    function pm() {
        ...
        om || (ui(''), om = !0);
    ...
    var sm = RegExp("^UA-\\d+-\\d+%3A[\\w-]+(?:%2C[\\w-]+)*(?:%3BUA-\\d+-\\d+%3A[\\w-]+(?:%2C[\\w-]+)*)*$"),
        tm = /^~?[\w-]+(?:\.~?[\w-]+)*$/,
    ...
    function zm(a, b) {
        if (um.test(D.location.host)) {
            ...
            return c && 2 == c.length && c[1].match(sm) ? decodeURIComponent(c[1]) : ""
        }
        var d = [],
            e;
        for (e in a) {
    ...
    function Bm(a, b, c) {
        if (um.test(D.location.host)) {
            ...
            if (d && 2 == d.length && d[1].match(tm)) return [{
                aa: d[1]
            }]
    ...
    var Cm = function(a) {
            return Bm(a, "_aw", xm).map(function(b) {
                return b.aa
            }).join(".")
        },
        Dm = function(a) {
            return Bm(a, "_gb", ym).map(function(b) {
                return b.aa
            }).join(".")
        },
        Em = function(a, b) {
    ...
    var co = function(a, b) {
        ...
        if (b) {
            var d = pi(a, "random"),
                e = pi(a, "label") || "";
            if (!d) return !1;
            var f = pk(decodeURIComponent(e.replace(/\+/g, " ")) + ":" + decodeURIComponent(d.replace(/\+/g, " ")));
            if (!bo(f, b)) return !1
        }
        c && 4 != c && (a = ri(a, "rfmt", c));
        var g = ri(a, "fmt", 4);
    ...
    var Co = function(a, b, c, d) {
            if (!Bo() && !bi(a)) {
                ...
                if (!m) {
                    var n = we.md + e;
                    k && Cb && g && (n = Cb.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0]);
                    m = ml("https://", "http://", n + f)
                }
                $h().container[a] = {
                    state: 1,
        ...
        Do = function(a, b, c) {
            ...
            if (d)
                if (ci()) $h().destination[a] = {
                    state: 0,
                    transportUrl: b,
                    context: c
                }, J(91);
                else {
                    var f = "/gtag/destination?id=" + encodeURIComponent(a) + "&l=" + we.ca + "&cx=c";
                    Ao() && (f += "&sign=" + we.Vd);
    ...
    var Eo = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        Fo = {
            cl: ["ecl"],
        ...
        Ho = "google customPixels customScripts html nonGooglePixels nonGoogleScripts nonGoogleIframes".split(" "),
        Ko = function(a) {
            var b = Ze("gtm.allowlist") || Ze("gtm.whitelist");
            b && J(9);
            De && (b = ["google", "gtagfl", "lcl", "zone"]);
            Io() && (De ?
                J(116) : J(117), Jo && (b = [], window.console && window.console.log && window.console.log("GTM blocked. See go/13687728.")));
            var c = b && Ka(Ca(b), Fo),
                d = Ze("gtm.blocklist") || Ze("gtm.blacklist");
            d || (d = Ze("tagTypeBlacklist")) && J(3);
            d ? J(8) : d = [];
            Io() && (d = Ca(d), d.push("nonGooglePixels", "nonGoogleScripts", "sandboxedScripts"));
            ...
            return function(g) {
                ...
                var v = !n || u;
                v || !(0 <= m.indexOf("sandboxedScripts")) || c && -1 !== c.indexOf("sandboxedScripts") || (v = va(e, Ho));
                return f[k] = v
            }
        },
        Jo = !1;
    ...
    var Lo = {
        ...
        Oo = 0 <= D.location.search.indexOf("?gtm_diagnostics=") || 0 <= D.location.search.indexOf("&gtm_diagnostics="),
        Qo = function(a, b, c) {
            if (aj && "config" === a && !(1 < jl(b).K.length)) {
                var d, e = Db("google_tag_data", {});
                e.td || (e.td = {});
                d = e.td;
                var f = G(c.I);
                G(c.h, f);
    ...
    var pq = function(a) {
            var b = xe.zones;
            return b ? b.getIsAllowedFn(Xh(), a) : function() {
                return !0
            }
        },
        qq = function(a) {
    ...
    function zq(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                Q(58) || 0 !== Bc[c][bc.Na].indexOf("__ccd") && 0 !== Bc[c][bc.Na].indexOf("__ogt") && "__set_product_settings" !== Bc[c][bc.Na] || (b[c] = !0)
            }
        return b
    }
            ...
            if (d.W) {
                ...
                if (f) {
                    ...
                    var u = jl(d.W).prefix,
                        ...
                        r = hm(fm(em(dm(bm(am(cm($l(Zl(Yl(new Xl(d.messageContext.eventId, d.messageContext.priorityId), g), k), m), n), p), q), d.messageContext.eventMetadata), function() {
                            if (t) {
                                var v = t;
                                t = void 0;
                                v("2")
                    ...
                    try {
                        lk(d.messageContext.eventId, u, "1"), Qo(d.type, d.W, r), f(d.W, b, d.m, r)
                    } catch (v) {
    ...
    Hq.prototype.push = function(a, b, c, d) {
        if (void 0 !== c) {
            ...
            if (c) {
                var e = jl(c);
                e && 1 === Iq(this, c).status && (Iq(this, c).status = 2, this.push("require", [{}], e.T, {}))
            }
    ...
    Hq.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            var f = this.h[0];
            if (f.messageContext.deferrable) !f.W || Iq(this, f.W).m ? (f.messageContext.deferrable = !1, this.h.push(f)) : c.push(f), this.h.shift();
            else {
                var g = void 0;
                switch (f.type) {
                    case "require":
    ...
    var Kq = function(a, b) {
            if ("require" !== b.type)
                if (b.W)
                    for (var c = Iq(a, b.W).M[b.type] || [], d = 0; d < c.length; d++) c[d]();
                else
                    for (var e in a.m)
    ...
    var Mq = {},
        ...
        Oq = function(a) {
            for (var b = [], c = [], d = {}, e = 0; e < a.length; d = {
                ...
                var f = a[e];
                if (0 <= f.indexOf("-")) d.ld = jl(f), d.ld && (sa(Yh(), function(p) {
                    return function(q) {
                        return p.ld.T === q
                    }
                }(d)) ? b.push(f) : c.push(f));
    ...
    var Vq = {
            ...
            event: function(a, b) {
                ...
                if (!(2 > a.length) && h(c)) {
                    ...
                    var e = d,
                        f = {},
                        g = (f.event = c, f);
                    e && (g.eventModel = G(e), e[N.g.Ob] && (g.eventCallback = e[N.g.Ob]), e[N.g.Fd] && (g.eventTimeout = e[N.g.Fd]));
                    var k = Uq(a, b),
                        m = k.eventId,
                        n = k.priorityId;
                    ...
                    var q = d,
                        u = q && q[N.g.Bb];
                    void 0 === u && (u = Ze(N.g.Bb, 2), void 0 === u && (u = "default"));
                    if (h(u) || ra(u)) {
                        var t = u.toString().replace(/\s+/g, "").split(","),
                            ...
                            w = r.bk;
                        if (w.length)
                            for (var y = q && q[N.g.ma] || Cq.B[N.g.ma], x = 0; x < w.length; x++) {
                                var B = jl(w[x]);
                                B && Do(B.T, y, {
                                    source: 3,
                                    fromContainerExecution: b.fromContainerExecution
                    ...
                    if (A) {
                        ...
                        0 < A.length ? g.eventModel[N.g.Bb] = C.join() : delete g.eventModel[N.g.Bb];
                        Sq || J(43);
            ...
            set: function(a, b) {
                var c;
                2 == a.length && Zb(a[1]) ? c = G(a[1]) : 3 == a.length && h(a[1]) && (c = {}, Zb(a[2]) || ra(a[2]) ? c[a[1]] = G(a[2]) : c[a[1]] = a[2]);
                if (c) {
                    var d = Uq(a, b),
                        e = d.eventId,
                        f = d.priorityId;
    ...
    var kr = function() {
            try {
                var a, b;
                var m, n = S.C,
                    p = Hd('script[src*="gtm/js?id=' + n + '"],script[src*="optimize.js?id=' + n + '"]');
        ...
        dr = function(a, b) {
            ...
            if (q) {
                if (b) {
                    var u = q.getEntriesByName(b)[0];
                    if (u) {
                        var t = q.getEntriesByType("resource"),
                            r = 0;
                        t && 0 < t.length && (r = t[0].startTime);
                        f = Math.round(u.startTime - r);
                        g = Math.round(u.duration);
                        e = t.indexOf(u); - 1 === e && (e =
                            void 0);
                        k = Math.round(a - (u.startTime + u.duration))
                    }
                }
                var v = q.timing;
        ...
        nr = !1,
        cr, er, fr, mr, gr, hr, ir;
    mr = Math.random(), nr = "0.050000" > mr;
    var or = function() {
            if (!nr || cr) return;
            cr = Fa();
            er = Ub() || cr;
            fr = !!D.querySelector("body");
            var a = lr(),
                b = a.th;
            hr = a.wh;
            ir = b ? cr - b : void 0;
    ...
    function Cr(a, b) {
        ...
        if (!a.event) return !1;
        "number" !== typeof d && (d = Re(), a["gtm.uniqueEventId"] = d, bf("gtm.uniqueEventId", d));
        return Bq(a)
    }
        ...
        for (var a = !1, b; !yr && (b = Er());) {
            ...
            if (null == d) yr = !1;
                ...
                try {
                    ...
                    if ("number" === typeof x) {
                        for (var B = ur[String(x)] || [], A = 0; A < B.length; A++) wr.push(Gr(B[A]));
                        B.length && wr.sort(zr);
                        delete ur[String(x)];
                        x > tr && (tr = x)
                    }
    ...
    function gq(a) {
        if (tr < a.notBeforeEventId) {
            ...
            ur[b] = ur[b] || [];
            ur[b].push(a)
        } else wr.push(Gr(a)), wr.sort(zr), F(function() {
            yr || Fr()
        })
    }
    ...
    var Jr = function() {
            ...
            b.push = function() {
                ...
                if (0 < xe.SANDBOXED_JS_SEMAPHORE) {
                    g = [];
                    for (var k = 0; k < arguments.length; k++) g[k] = new sr(arguments[k])
    ...
    var ls = z.clearTimeout,
        ...
        ss = function(a, b, c) {
            var d;
            b ? (a.eventCallback = b, c && (a.eventTimeout = c), d = Ar(a)) : d = Ar(a);
            return d
        },
        ts = function(a, b) {
            z[a] = b
    ...
    var Bs = function(a) {
        ...
        Js = function(a) {
            ...
            for (var b = a.styleSheets.length - 1; 0 <= b; b--) {
                ...
                if (!c.href) {
                    var d = c.ownerNode;
                    if (d && d.parentNode && "HEAD" == d.parentNode.tagName) return Ns = c
                }
            }
            0 == a.styleSheets.length && a.createStyleSheet();
            return Ns = a.styleSheets[0]
        },
        Ks = function(a, b) {
    ...
    var uu = window,
        ...
        wu = function(a) {
            ...
            for (var d = Af("AMP_TOKEN", String(vu.cookie), !0), e = 0; e < d.length; e++)
    ...
    var uw = function(a) {
            if (!sw[a]) {
                ...
                var c = function(e) {
                    ...
                    d = b.get;
                b.get = d ? function(e) {
                    return void 0 !== tw[e] ? tw[e] : d(e)
                } : c
            }
        },
        xw = function(a, b) {
            tw[a] = b;
            for (var c = vw(a), d = 0; d < c.length; d++) ww(c[d], a, b);
            c = vw("");
            for (var e = 0; e < c.length; e++) ww(c[e], a, b)
        },
        ww = function(a, b, c) {
            try {
                a(c, b, S.C)
    ...
    var zw = function() {
        ...
        Hw = function(a, b) {
            ...
            if (c) F(function() {
                ...
                var d = Bw(a)[0];
                d ? (Cw[a] = d, Dw || (Dw = d), F(function() {
                    return b(d)
                })) : (Ew[a] || (Ew[a] = []), Ew[a].push(b), Fw || (Fw = !0, Aw(function(e) {
                    ...
                    if (Ew[f]) {
                        ...
                        Dw || (Dw = e);
                        Cw[f] = e;
                        for (var k = Ew[f], m; void 0 !== (m = k.shift());) m(e);
                        Ew[f] = void 0
                    }
                })))
            }
        ...
        Zw = function(a, b, c, d, e, f) {
            ...
            if (Xw(a)) xe.ga4_referrer_override = g, Yw(a, b, c, e, f);
            else {
                Mw(a, b, c);
                for (var m = Bw(a), n = 0; n < m.length; ++n) m[n].set("referrer", d ? d : void 0);
                if (0 < Sw(a)) {
                    var p = m[0];
                    p && Iw(p, {
                        hitType: "data"
        ...
        Yw = function(a, b, c, d, e) {
            if (Xw(a)) {
                var f = cq(a, "experiment_impression", {
                    experiment_id: b,
                    variant_id: c
                });
                fq(f, d, {
    ...
    var cx = function(a, b, c) {
            function d() {
                f || (f = !0, !0 !== $w && ($w = !1), ax(c), Xq(e))
            }
            pr = a;
            var e = "OPT-54C5LBG_" + b,
                f = !1;
            Yq(e);
            z.google_optimize = z.google_optimize || {};
            var g = z.google_optimize;
            g["OPT-54C5LBG"] = g["OPT-54C5LBG"] || {};
            g["OPT-54C5LBG"].optimize_dyn = function(m) {
            ...
            if (a || b || c) {
                ...
                if (f && (a || c || p)) {
                    ...
                    var v = function(w) {
                        Jw = w;
                        dx = Fa();
                        a || b ? (t = "https://www.google-analytics.com/gtm/optimize-dyn.js?id=OPT-54C5LBG", a && n("cid", w), n("gclid",
                            p), g && (n("gtm_auth", ""), n("gtm_preview", "")), (g || a) && n("cb", String(Math.random())), cx(t, u++, e)) : ax(e);
                        Xq(r)
                    };
                    Xw(d) ? fq(aq("get", d, "client_id", v), k, {
                        originatingEntity: m,
                        deferrable: !0
                    }) : (Gw[d] = !0, Hw(d, function(w) {
    ...
    var ix = function() {
        ...
        jx = function(a, b) {
            ...
            this.B = a || "auto";
            this.h = b || ix();
            this.m = new gx(Uf(this.B), Vf(this.h));
            this.K = [];
            this.map = {}
        };
    aa = jx.prototype;
    ...
    aa.wk = function(a, b, c, d, e) {
        var f, g;
        f = void 0 === f ? 10 : f;
        g = void 0 === g ? 3E3 : g;
        if (!a) return !1;
        void 0 == b && (b = "");
        this.oe(a, new hx(b, c));
        this.dj(e);
        return this.Oi(d,
            f, g)
    };
    ...
    aa.Bj = function() {
        for (var a = 0, b = 0; b < this.K.length; b++) "x" !== this.nf(this.K[b]).m[0] && a++;
        return a
    };
    aa.oe = function(a, b) {
        a && ("" === b.m ? this.Ih(a) : (this.map[a] || this.K.push(a), this.map[a] = b))
    };
    aa.Bk = function(a) {
    ...
    aa.Oi = function(a, b, c) {
        ...
        var e = this.Bj();
        if (e >
            b || e > (a || 10) && Ff().replace(RegExp("(?:;\\s*)?(_gaexp=[^;]+)(?:;\\s*)?"), this.toString()).length > c) return !1;
        d.setTime(this.sj());
        if ("auto" != this.B) return this.m = new gx(Uf(this.B), Vf(this.h)), 0 === Pf("_gaexp", this.toString(), {
            path: this.h,
            domain: this.B,
            expires: d
        });
        for (var f = Mf(), g = 0; g < f.length; g++)
            if (this.m = new gx(Uf(f[g]), Vf(this.h)), 0 === Pf("_gaexp", this.toString(), {
                    path: this.h,
                    domain: f[g],
                    expires: d
                })) return !0;
    ...
    aa.dk = function() {
        var a = Jf("_gaexp", this.m.ae, this.m.Zc);
        if (a) {
            var b = this.ek(a);
            b &&
                this.Bk(b.Aj())
    ...
    aa.ek = function(a) {
        for (var b = new jx(this.B, this.h), c = a.split("!"), d = 0; d < c.length; d++) {
            var e = c[d].split(".");
            if (3 == e.length) {
                if (isNaN(Number(e[1]))) return;
                b.oe(e[0], new hx(e[2], Number(e[1])))
            }
        }
        return b
    };
    ...
    var px = function() {
            ...
            nx && (nx.takeRecords(), mx.length || (nx && (nx.disconnect(), nx = null), ox && (z.clearTimeout(ox), ox = null)))
        },
        rx = function() {
            var a = Fa() - lx;
            a >= qx ? (ox && (z.clearTimeout(ox), ox = null), px()) : ox || (ox = z.setTimeout(function() {
                px();
                ox = null
            }, qx - a))
        },
        sx = function(a) {
            ...
            try {
                return nx || (nx = new MutationObserver(rx), nx.observe(D.documentElement, {
                    subtree: !0,
                    childList: !0,
                    attributes: !0,
                    characterData: !0
    ...
    var tx = function(a, b) {
        ...
        wx = function(a, b) {
            for (var c = ux(a.fa) || [], d = [], e = 0; e < c.length; e++) {
                var f = c[e];
        ...
        zx = function(a, b, c) {
            ...
            if (b.Ia)
                if (b.Ia.df) d = [{
                    ...
                    var f = wx(b.Ia, b.id),
                        g = null;
                    b.pe && (g = wx(b.pe, b.id + "-t"));
                    for (var k = 0; k < f.length; k++) {
                        var m = f[k],
                            n = void 0;
                        if (null != g && (n = g.length > k ? g[k] : null, !n && !So && (null === b.pe.da || b.lh + e.length < b.pe.da))) break;
                        e.push({
                            element: m,
                            targetElement: n
                        })
            ...
            var p = d;
            if (!So && b.aj && (!a || null == b.Ia.da || b.Ia.da != b.Yd + p.length)) return !1;
            for (var q = 0; q < p.length; q++) {
                var u = p[q].element,
                    t = p[q].targetElement,
                    r = void 0;
                b.Yd++;
                yx(u, b.id);
                t && (b.lh++, r = b.id + "-t", yx(t, r));
                var v = b.ej(u, t);
                pa(v) && b.ac.push(v);
                b.ac.push(xx(u, b.id));
                t && r && b.ac.push(xx(t, r))
            }
            if (b.Ia.da && b.Ia.da == b.Yd || So && (!c || b.Yd)) b.finished = !0;
            return !0
        },
        Ax = function(a) {
            for (var b = {}, c = 0; c < a.Ha.length; c++) {
                var d = a.Ha[c];
                if (!d.Ia.df) {
                    var e = b[d.Ia.fa];
                    e || (e = b[d.Ia.fa] = ux(d.Ia.fa) || []);
                    for (var f = 0; f < e.length; f++) {
                        var g = e[f];
                        g.gtmProgressiveApplied && g.gtmProgressiveApplied[d.id] || (yx(g, d.id), d.ac.push(xx(g, d.id)))
                    }
                }
            }
        },
        Bx = function(a) {
            if (!a.Hf) {
                for (var b =
                        a.Qc; b < a.Ha.length; b++) {
                    var c = a.Ha[b],
                        d = b == a.Qc;
                    if (!c.finished && !zx(d, c, a.Wh && a.Qh)) break;
                    c.finished && d && a.Qc++
                }
                a.Ha.length > a.Qc ? (!a.pending && a.Wh && (a.pending = !0, tx(function() {
                    a.pending = !1;
                    Bx(a)
                }, a.Qh)), So || a.Bf || (a.Bf = function() {
                    F(function() {
                        Bx(a)
                    })
                }, Mb(D, "DOMContentLoaded", a.Bf))) : Ax(a)
            }
        },
        Cx = {},
        Dx = {},
        ...
        Fx = function(a, b, c, d) {
            ...
            e.Ha.push(f);
            null === a ? (f.finished = !0, b(null)) : Bx(e);
            return !0
        },
        Gx = function(a) {
            var b = oa;
            try {
                b = Ms(a, "visibility", "hidden", !0)
            } catch (c) {}
            return function() {
                pa(b) && b.apply();
                b = null
    ...
    Z.o.c = ["google"],
        function() {
            (function(a) {
                ...
                zs(a.vtp_value, "c", a.vtp_gtmEventId);
                return a.vtp_value
            })
        }();
    Z.o.e = ["google"],
    ...
    Z.o.u = ["google"],
        function() {
            ...
            (function(b) {
                ...
                var c;
                c = (c = b.vtp_customUrlSource ? b.vtp_customUrlSource : rs("gtm.url", 1)) || os();
                var d = b[a("vtp_component")];
                if (!d || "URL" == d) return qs(String(c));
                var e = qd(String(c)),
                    f;
                if ("QUERY" === d) a: {
                    ...
                    for (var p = 0; p < n.length; p++) {
                        var q = od(e, "QUERY", void 0, void 0, n[p]);
                        if (void 0 != q && (!m || "" !== q)) {
                            f = q;
                            break a
                        }
                ...
                else f = od(e, d, "HOST" == d ? b[a("vtp_stripWww")] : void 0, "PATH" == d ? b[a("vtp_defaultPages")] : void 0);
                return f
            })
        }();
        ...
        function() {
            (function(a) {
                ...
                var b = a.vtp_treatmentId,
                    ...
                    e = a.vtp_isEmpty,
                    f = rs("optimize.experimentCallback", 1),
                ...
                if (p) a.vtp_gtmOnFailure();
                    ...
                    var u = rs("optimize.allowlist", 1) || rs("optimize.whitelist",
                        1);
                    if (u && u[g] ? u[g] === d : Io() ? e : 1) {
                        if (pa(f)) {
                            var t = {
                                xid: g,
                                xvar: k,
                        ...
                        if (c) {
                            ...
                            var y = Dx[b];
                            if (y) {
                                for (var x = y.Qc = 0; x < y.Ha.length; x++) y.Ha[x].finished = !1;
                                Bx(y);
                                w = !0
                            } else w = !1;
                            if (w) r = !0;
                            ...
                            if (!A || A.Hf) v = !1;
                                ...
                                for (; A.Ha.length;)
                                    for (var C = A.Ha.pop(); C.ac.length;) {
                                        var H = C.ac.pop();
                                        if (pa(H)) try {
                                            H()
                                        } catch (I) {}
                ...
                if (g && pa(g))
                    if (f = String(f), !0 !== k) {
                        var m = f,
                            n = g;
                        vw(m).push(n);
                        if ("" !== m) void 0 !== tw[m] && ww(n, m, tw[m]);
                        else
                            for (var p in tw) void 0 !==
                                tw[p] && ww(n, p, tw[p])
                    } else {
                        var q = g,
                            u = vw(f),
    ...
    Z.o.gaoo_c = ["google"],
        function() {
            (function(a) {
                ...
                if (D.getElementById("__gaOptOutExtension")) return !0;
                var c = W("external");
    ...
    Z.o.exs = ["google"],
        function() {
            (function(a) {
                ...
                var b = kx(a.vtp_cookieDomain, a.vtp_cookiePath).Dj(a.vtp_measurementId);
                if ("" === b) return b;
                if ("x" === b[0]) {
    ...
    Z.o.exsu = ["google"],
        function() {
            (function(a) {
                ...
                kx(a.vtp_cookieDomain, a.vtp_cookiePath).wk(a.vtp_measurementId, a.vtp_newState, a.vtp_expirationDay, a.vtp_max, a.vtp_expirationDates) ? a.vtp_gtmOnSuccess() : a.vtp_gtmOnFailure()
            })
        }();
    Z.o.ctto = ["google"],
        function() {
    ...
    Z.o.eximp = ["google"],
        function() {
            ...
            (function(b) {
                ...
                } else Yw(c, d, e, b.vtp_gtmEventId,
                    Yo(b.vtp_gtmEntityIndex, b.vtp_gtmEntityName));
                b.vtp_gtmOnSuccess()
            })
        }();
    var Jx = {};
    ...
    (function(a) {
        ...
        if (!z["__TAGGY_INSTALLED"]) {
            ...
            c && (z["__TAGGY_INSTALLED"] = !0, Ib("https://cct.google/taggy/agent.js"))
        }
        if (Je) a();
        else {
            var f = function(r) {
                    ...
                    y || (y = [],
                        z["google.tagmanager.debugui2.queue"] = y, Ib("https://" + we.md + "/debug/bootstrap?id=" + S.C + "&src=" + w + "&cond=" + r + "&gtm=" + gi()));
                    var x = {
        ...
        if (S.Ra ? xe["ctid_" + S.Ra] : xe[S.C]) {
            ...
            So = !1;
            To = 0;
            if ("interactive" == D.readyState && !D.createEventObject || "complete" == D.readyState) Vo();
            else {
