        ...
        TRC.eid = {
            ...
            collectEidFromPage: function b(t, e) {
                if (t && t.value && c(t.value)) {
                    ...
                    this.sha256(m, function(b) {
                        b = TRC.eid.processEid(b), TRC.eid.storeEid(b), e(t)
                    })
                }
            },
            ...
            sendEidToTrc: function b(t, e) {
                var c, m = TRC.eid.getProtocol(),
                    n = [],
                    a = TRC.eid.getUserId();
                if (t && a) return TRC.eid.safeAddParam("uils", a, n), TRC.eid.safeAddParam(W, TRC.eidls.processEid(t), n), e && TRC.eid.safeAddParam(d, e, n), c = new Image, (TRC.eid.safeGetTfaConfig("tfa:add-referrer-policy-when-firing-pixel", !0) || TRC.eid.safeGetRboxConfig("rbox:add-referrer-policy-when-firing-pixel")) && (c.referrerPolicy = "no-referrer-when-downgrade"), c.src = m + "//trc.taboola.com/sg/tfa-eid/1/um/?" + n.join("&"), c
            },
